...
function delSupp(i){if(CR!=="manager"){toast("⚠️ صلاحية المدير");return;}var nm=S.suppliers[i]&&S.suppliers[i].name;rhConfirm('حذف "'+nm+'"؟',function(){S.suppliers.splice(i,1);buildPurchSupp();renderSuppList();renderSuppRpt();saveAll();toast("🗑️ تم الحذف");},{icon:'🗑️',title:'حذف مورد',yesText:'حذف',noText:'إلغاء'});}
