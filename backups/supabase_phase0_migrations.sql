...
-- (5) migration: rh_store_trigger_security_definer_fix  ← مهم
--     السبب الجذري لإشعارات "تعذّر الوصول للسحابة" (HTTP 401): مُشغِّل #4 كان
--     يكتب في rh_store_history بصلاحيات العميل (anon) الذي لا يملك INSERT على
--     جدول الأرشيف => كل حفظ يغيّر البيانات يفشل 42501 => 401.
--     الإصلاح: جعل rh_store_before_write() بصيغة SECURITY DEFINER
--     (الأرشفة تتم بصلاحية المالك؛ العميل لا يلمس جدول الأرشيف مباشرة).
--     تم التحقق: anon=OK و authenticated=OK على إدخال حقيقي يغيّر البيانات.
